...
func (v Delta) Components() (x, y float32) { _ = "STUB: not implemented"; return 0, 0 }
...
func (p Position) Components() (x, y float32) { _ = "STUB: not implemented"; return 0, 0 }
...
func (s Size) Components() (width, height float32) { _ = "STUB: not implemented"; return 0, 0 }
