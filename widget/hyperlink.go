...
func NewHyperlink(text string, u *url.URL) *Hyperlink { _ = "STUB: not implemented"; return nil }
...
func (hl *Hyperlink) SetURL(u *url.URL) { _ = "STUB: not implemented"; return }
...
func (*Hyperlink) TypedRune(rune) { _ = "STUB: not implemented"; return }
...
func (*hyperlinkRenderer) Destroy() { _ = "STUB: not implemented"; return }
