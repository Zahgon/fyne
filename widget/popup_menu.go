...
func (*PopUpMenu) FocusGained() { _ = "STUB: not implemented"; return }

func (*PopUpMenu) FocusLost() { _ = "STUB: not implemented"; return }
...
func (*PopUpMenu) TypedRune(rune) { _ = "STUB: not implemented"; return }
