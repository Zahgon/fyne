...
func (t *Table) MouseUp(*desktop.MouseEvent) { _ = "STUB: not implemented"; return }
...
func (t *Table) TouchUp(*mobile.TouchEvent) { _ = "STUB: not implemented"; return }

func (t *Table) TouchCancel(*mobile.TouchEvent) { _ = "STUB: not implemented"; return }

func (t *Table) TypedKey(event *fyne.KeyEvent) { _ = "STUB: not implemented"; return }

func (t *Table) TypedRune(_ rune) { _ = "STUB: not implemented"; return }
