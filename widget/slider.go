...
func NewSlider(minValue, maxValue float64) *Slider { _ = "STUB: not implemented"; return nil }
...
func (*Slider) MouseMoved(_ *desktop.MouseEvent) { _ = "STUB: not implemented"; return }
...
func (*Slider) TypedRune(_ rune) { _ = "STUB: not implemented"; return }

func (*Slider) buttonDiameter(inlineIconSize float32) float32 { _ = "STUB: not implemented"; return 0 }
