...
func (r *labelRenderer) Destroy() { _ = "STUB: not implemented"; return }
...
func (f *focusSelectable) TypedKey(*fyne.KeyEvent) { _ = "STUB: not implemented"; return }

func (f *focusSelectable) TypedRune(rune) { _ = "STUB: not implemented"; return }
