...
func (*Form) detachValidation(widget fyne.CanvasObject) { _ = "STUB: not implemented"; return }
...
func (f *Form) createLabel(item *FormItem) *RichText { _ = "STUB: not implemented"; return nil }
