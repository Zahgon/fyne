...
func (e *Entry) Cursor() desktop.Cursor { _ = "STUB: not implemented"; return *new(desktop.Cursor) }
...
func (e *Entry) MouseUp(m *desktop.MouseEvent) { _ = "STUB: not implemented"; return }
...
func (e *Entry) Tapped(ev *fyne.PointEvent) { _ = "STUB: not implemented"; return }
...
func (e *Entry) TouchUp(*mobile.TouchEvent) { _ = "STUB: not implemented"; return }

func (e *Entry) TouchCancel(*mobile.TouchEvent) { _ = "STUB: not implemented"; return }
...
func (e *Entry) truncatePosition(row, col int) (int, int) { _ = "STUB: not implemented"; return 0, 0 }
...
func (r *entryRenderer) Destroy() { _ = "STUB: not implemented"; return }
