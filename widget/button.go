...
func (*Button) Cursor() desktop.Cursor { _ = "STUB: not implemented"; return *new(desktop.Cursor) }
...
func (*Button) MouseMoved(*desktop.MouseEvent) { _ = "STUB: not implemented"; return }
...
func (*Button) TypedRune(rune) { _ = "STUB: not implemented"; return }
