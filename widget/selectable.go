...
func (*selectable) Cursor() desktop.Cursor { _ = "STUB: not implemented"; return *new(desktop.Cursor) }
...
func (s *selectable) TouchDown(*mobile.TouchEvent) { _ = "STUB: not implemented"; return }

func (*selectable) TouchUp(*mobile.TouchEvent) { _ = "STUB: not implemented"; return }
...
func (s *selectable) selectCurrentRow(bool) { _ = "STUB: not implemented"; return }

func (s *selectable) selection() (start, end int) { _ = "STUB: not implemented"; return 0, 0 }
...
func (*selectableRenderer) Destroy() { _ = "STUB: not implemented"; return }

func (*selectableRenderer) Layout(fyne.Size) { _ = "STUB: not implemented"; return }

func (*selectableRenderer) MinSize() fyne.Size { _ = "STUB: not implemented"; return *new(fyne.Size) }
