...
func (*Select) MouseMoved(*desktop.MouseEvent) { _ = "STUB: not implemented"; return }
...
func (*Select) TypedRune(_ rune) { _ = "STUB: not implemented"; return }
...
func (*selectRenderer) Destroy() { _ = "STUB: not implemented"; return }
