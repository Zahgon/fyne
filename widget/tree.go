...
func (*Tree) TypedRune(_ rune) { _ = "STUB: not implemented"; return }
...
func (r *treeRenderer) MinSize() fyne.Size { _ = "STUB: not implemented"; return *new(fyne.Size) }
...
func (r *treeContentRenderer) getBranch() *branch { _ = "STUB: not implemented"; return nil }

func (r *treeContentRenderer) getLeaf() *leaf { _ = "STUB: not implemented"; return nil }
...
func (*treeNode) MouseMoved(*desktop.MouseEvent) { _ = "STUB: not implemented"; return }
...
func (r *treeNodeRenderer) MinSize() fyne.Size { _ = "STUB: not implemented"; return *new(fyne.Size) }
