...
func (*app) Icon() fyne.Resource { _ = "STUB: not implemented"; return *new(fyne.Resource) }

func (*app) SetIcon(fyne.Resource) { _ = "STUB: not implemented"; return }
...
func (*app) OpenURL(_ *url.URL) error { _ = "STUB: not implemented"; return nil }

func (*app) Run() { _ = "STUB: not implemented"; return }

func (*app) Quit() { _ = "STUB: not implemented"; return }
...
func (*app) UniqueID() string { _ = "STUB: not implemented"; return "" }
...
func (*app) Metadata() fyne.AppMetadata { _ = "STUB: not implemented"; return *new(fyne.AppMetadata) }
...
func (s *testSettings) SetTheme(t fyne.Theme) { _ = "STUB: not implemented"; return }

func (*testSettings) ShowAnimations() bool { _ = "STUB: not implemented"; return false }
