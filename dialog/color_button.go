...
func (b *colorButton) MouseMoved(*desktop.MouseEvent) { _ = "STUB: not implemented"; return }

func (b *colorButton) MinSize() fyne.Size { _ = "STUB: not implemented"; return *new(fyne.Size) }

func (b *colorButton) SetColor(color color.Color) { _ = "STUB: not implemented"; return }
