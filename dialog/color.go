...
func clamp(value, minValue, maxValue int) int { _ = "STUB: not implemented"; return 0 }
...
func writeRecentColor(c string) { _ = "STUB: not implemented"; return }
...
func rgbToHsl(r, g, b uint8) (h, s, l int) { _ = "STUB: not implemented"; return 0, 0, 0 }

//revive:disable-line:add-constant

func hslToRgb(h, s, l int) (r, g, b uint8) { _ = "STUB: not implemented"; return 0, 0, 0 }
