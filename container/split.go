...
func (r *splitContainerRenderer) Destroy() { _ = "STUB: not implemented"; return }
...
func (d *divider) MouseIn(event *desktop.MouseEvent) { _ = "STUB: not implemented"; return }

func (d *divider) MouseMoved(event *desktop.MouseEvent) { _ = "STUB: not implemented"; return }
...
func (r *dividerRenderer) Destroy() { _ = "STUB: not implemented"; return }
