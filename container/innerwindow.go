...
func (w *InnerWindow) SetMaximized(maximized bool) { _ = "STUB: not implemented"; return }
...
func (*draggableLabel) DragEnd() { _ = "STUB: not implemented"; return }
...
func (*draggableCorner) DragEnd() { _ = "STUB: not implemented"; return }
